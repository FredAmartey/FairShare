...
Link to wiki: https://github.com/FredAmartey/FairShare/wiki
...
1. **Clone the repository**:
   ```bash
   git clone https://github.com/FredAmartey/FairShare.git
   cd FairShare
   npm install
   ```
...
🔗 [CI Pipeline Scripts – GitHub Workflows](https://github.com/FredAmartey/FairShare/tree/main/.github/workflows)
